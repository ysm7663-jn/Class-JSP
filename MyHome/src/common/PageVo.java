...
public class PageVo {
	...
	private int page = 1;		   // 현재 페이지의 번호(기본 1페이지 사용)
	...
	public void setTotalPage() {
		totalPage = totalRecord / recordPerPage; // 20 / 3 == 6 (나머지2개)
		if(totalRecord % recordPerPage != 0) {   // totalRecord에서 recordPerPage를 나눈 나머지값이 0이 아니라면
			totalPage++;						 // 남는 페이지들을 보관하기 위해 한페이지를 더 추가한다.
		}
	}
