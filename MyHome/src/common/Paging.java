...
public class Paging {
	...
	public static String getPaging(String path, int totalRecord, int recordPerPage, int page) {
		...
		totalPage = totalRecord / recordPerPage; // 전체 게시물의 개수에서 나누기 한 페이지당 게시물 개수
		...
		*/
		...
		/*
		 * 	겁나중요!!
			/MyHome/boardListPage.board  ?page=1 ( 전달되는 파라미터 없음)
			/MyHome/myboardListPage.board  ?page=1 ( 전달되는 파라미터 없음)
